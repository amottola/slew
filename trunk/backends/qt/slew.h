...
int convertPicture(PyObject *object, QPicture *value);
...
bool getObjectAttr(PyObject *object, const char *name, QPicture *value);
...
bool messageBox(QWidget *window, const QString& title, const QString& message, PyObject *buttons, int icon, PyObject *callback, PyObject *userdata, int *button);
