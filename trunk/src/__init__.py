...
MODIFIER_META						= 0x8
MODIFIER_NUM_LOCK					= 0x10
MODIFIER_CAPS_LOCK					= 0x20
MODIFIER_SCROLL_LOCK				= 0x40
MODIFIER_FUNCTION					= 0x80
...
class DataSpecifier(object):
	...
	FIXED_WIDTH			= 0x00400000
	SEPARATOR			= 0x00800000
	CLICKABLE_URLS		= 0x01000000
